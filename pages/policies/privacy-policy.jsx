        ...
        <div className="container">
          <section className="mt-10 pt-3">
            ...
            <p>
              ...
              Website you hereby accept and consent to the terms of this Privacy
              Policy. Please note that our Website may contain links to websites
              of other organisations and when you access such external links,
              they may have different privacy policies specific to those
              websites. We encourage you to read all privacy policies posted on
          ...
          <section className="mt-10 pt-2">
            ...
            <p>
              Bodycupid may collect (i) personally identifiable information like
              name, telephone number, e-mail address, etc.; (ii) personal
              information; and (iii) sensitive personal information. While you
              can browse some sections of our Website without requiring
              registration, certain activities (such as placing an order) or
            ...
            <p>
              ...
              information received under each of the heads by the body corporate
              for processing, or to be stored or processed under a lawful
              contract. Provided that, any information that is freely available
            ...
            <p>
              ...
              information. We may also maintain digital communication logs that
              track information like your phone number, calling-party number,
          ...
          <section className="mt-10 pt-2">
            ...
            <p>
              Bodycupid may use any number of tools to collect information about
              you, your computer access points, mobile devices, and the web
              browser that you use to connect to our Website or digital
              applications. For example, “cookies” are text files that we place
              on your computer or mobile device when you visit our Website. We
              may use cookies to personalize your interactions with our Website.
              You do not have to accept our cookies and you may set your browser
              to restrict their use and you may delete them after they have been
              placed on your computer or mobile devices. If you do not accept or
              delete our cookies, our Website may take more time to work, or may
              not function properly. Effective consent may be provided by using
            ...
            <p>
              ...
              content, and product and service offerings. Some of this
              information, including the IP address, may be stored on our
              Internet service provider’s server logs, and may be available for
          ...
          <section className="mt-10 pt-2">
            ...
            <p>
              Bodycupid allows you to choose (opt out) whether your information
              is to be disclosed to a non-related third party for purposes other
              than Bodycupid related communications, business or services. For
              sensitive personal information, e.g., financial information,
              Bodycupid will give individuals the opportunity to explicitly (opt
              in) consent to the disclosure of the information for a purpose
          ...
          <section className="mt-10 pt-2">
            ...
            <p>
              At times Bodycupid may use the services of independent companies
              to provide certain services to you, including, without limitation,
              website hosting services, credit card processing, product
              promotions, order processing and shipping services, and visitor
              surveys. Bodycupid may share your personal information with the
              Internet service providers as appropriate under our business
            ...
            <p>
              ...
              establish or exercise our legal rights; (d) protect the property
              or safety of our company and employees, contractors, vendors,
              suppliers, and customers; (e) defend against legal claims; (f)
              help with internal and external investigations; or (g) as
              otherwise required by law or permitted by law. We may disclose
              your information in connection with the sale or merger of a
              Bodycupid or any transaction that involves the sale or assignment
          ...
          <section className="mt-10 pt-2">
            ...
            <p>
              We will only use your Personal Information for those purposes and
              will make sure that your privacy is protected. We shall take
              reasonable steps to delete or permanently de-identify Personal
          ...
          <section className="mt-10 pt-2">
            ...
            <p>
              Bodycupid implements a variety of security measures to maintain
              the safety of your personal information when you place an order.
              These security measures include: (i) password protected
              directories and databases to safeguard your information, (ii) SSL
          ...
          <section className="mt-10 pt-2">
            ...
            <p>
              Our Website is directed to be used by adults only and our
              Website’s content is not directed toward collecting information
              from anyone who is under the age of 18 (eighteen). We do not
              knowingly collect personal information from children or minors. If
              Bodycupid or its Internet service providers become aware that a
              child or minor has provided us with personal information without
          ...
          <section className="mt-10 pt-2">
            ...
            <p>
              The first time that you provide us with registration information
              through our Website, you may be offered the opportunity to
            ...
            <p>Bodycupid, Attn: Md. Naseer, Privacy/Grievance Officer</p>
            <p>Contact info: +91-9543000200</p>
            <p>E-mail at : support@bodycupid.com</p>
          </section>

          <section className="mt-10 pt-2">
            <h2 className="title title-simple">9. DATA INTEGRITY</h2>
            <p>
              Bodycupid will only process personal information and sensitive
              personal information in a way that is compatible with and relevant
          ...
          <section className="mt-10 pt-2">
            ...
            <p>
              Bodycupid uses a self-assessment approach to assure compliance
              with this Privacy Policy and periodically verifies that the policy
              is accurate, comprehensive for the information intended to be
              covered, by our privacy principles. We encourage interested
              persons to raise any concerns using the contact information
              provided and we will investigate and attempt to resolve any
              complaints or disputes regarding the use and disclosure of
              personal information and sensitive personal information in
          ...
          <section className="mt-10 pt-2">
            ...
            <p>
              Bodycupid may update this Privacy Policy from time to time, and
              you should take the time to review it each time that you visit our
              Website. By using our Website or providing us with personal
              information or sensitive personal information after we update this
              Privacy Policy, you agree to this Privacy Policy as revised.
              Bodycupid is committed to protecting your personal privacy. If you
              have questions or comments about our efforts to protect your
              personal privacy, or if you require additional information
              Bodycupid’s privacy commitment, please contact our Grievance
              Officer.
            </p>
          </section>
        </div>
