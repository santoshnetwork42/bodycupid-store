...
function AboutUs() {
  useEffect(() => {
    countToHandler();
    window.addEventListener("scroll", countToHandler, { passive: true });
  ...
  return (
    <main className="main about-us">
      ...
      >
        <h3 className="page-subtitle font-weight-bold">Welcome to Wow</h3>
              ...
              <div className="row align-items-center">
                ...
                <div className="col-md-5 mb-4">
                  ...
                  <p className="section-desc text-grey">
                    ...
                    Technolog
                    <br />
                    developing, requirements are increasing. Wow has brought.
                  </p>
                  <ALink
                    href="#"
