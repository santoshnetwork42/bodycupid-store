                ...
                >
                  ...
                  <div className="post-details">
                    <div className="post-meta">
                      ...
                      |{" "}
                      <ALink href="#" className="post-comment">
                    ...
                    <div className="post-body mb-7">
                      ...
                      <p className="mb-6">
                        ...
                        lacus a <ALink href="#">ultrices sagittis</ALink>, mi
                      ...
                      <div className="with-img row align-items-center">
                        ...
                        <div className="col-md-6 mb-6">
                          <h4 className="font-weight-semi-bold ls-s">
                            Quisque volutpat mattiseros.
                          </h4>
                          <p className="mb-8 col-lg-11">
                          ...
                          <ul className="list list-type-check mb-6">
                            ...
                            <li>
                              Dilisis Facilisis quis sapien. Praesent id enim
                              sit amet
                            </li>
                            <li>Praesent id enim sit amet.</li>
                            <li>
                      ...
                      <blockquote className="mt-1 mb-6 p-relative">
                        <p className="font-weight-semi-bold ls-m">
                    ...
                    <div className="post-author-detail">
                      ...
                      <div className="author-body">
                        <div className="author-header d-flex justify-content-between align-items-center">
                          <div>
                            <span className="author-title">AUTHOR</span>
                            <h4 className="author-name font-weight-bold mb-0">
                              John Doe
                            </h4>
                          </div>
                          <div>
                ...
                <nav className="page-nav">
                  ...
                  >
                    ...
                    <span className="pager-link-title">
                      {related[related.length - 1].title}
                    </span>
                  </ALink>
                </nav>
              )}
