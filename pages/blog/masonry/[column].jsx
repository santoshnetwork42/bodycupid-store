...
function PostMasonry({ router }) {
  ...
  return (
    <main className="main skeleton-body">
      <Head>
        <title>Wow React eCommerce Template | Blog Masonry {column}</title>
      </Head>

      <h1 className="d-none">
        Wow React eCommerce Template - Blog Masonry {column}
      </h1>
