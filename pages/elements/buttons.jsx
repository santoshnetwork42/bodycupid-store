            ...
            <div className="mb-10 pb-2">
              <div className="title-wrapper">
                ...
                <p className="text-center">
                  Select between any button styles and color you want.
                </p>
              </div>

              <div className="row">
                <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                  <ALink href="#" className="btn btn-block">
                    Default
                  </ALink>
                </div>
                <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                  <ALink href="#" className="btn btn-primary btn-block">
                    Primary Color
                  </ALink>
                </div>
                <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                  <ALink href="#" className="btn btn-secondary btn-block">
                    Secondary Color
                  </ALink>
                </div>
                <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                  <ALink href="#" className="btn btn-alert btn-block">
                    Alert Color
                  </ALink>
                </div>
                <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                  <ALink href="#" className="btn btn-success btn-block">
                    Success Color
                  </ALink>
                </div>
                <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                  <ALink href="#" className="btn btn-dark btn-block">
                    Dark Color
                  </ALink>
                </div>
              </div>
              ...
              <div className="col-lg-6 mb-10">
                ...
                <div className="row">
                  <div className="col-6 col-sm-4 col-md-3 col-lg-4">
                    <ALink href="#" className="btn btn-outline btn-block">
                      Default
                    </ALink>
                  </div>
                  <div className="col-6 col-sm-4 col-md-3 col-lg-4">
          ...
          <div className="container">
            <div className="mb-10 mt-4 pb-2">
              <div className="title-wrapper">
                ...
                <p className="text-center">
                  Add included Wow icons to default buttons, using any color.
                </p>
              </div>
              ...
              <div className="row">
                ...
                <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                  <ALink href="#" className="btn btn-block btn-reveal-left">
                    <i className="d-icon-arrow-left"></i>
                    <span>Reveal Left</span>
                  </ALink>
                </div>
                <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                  <ALink href="#" className="btn btn-block btn-reveal-right">
            ...
            <div className="row">
              ...
              <div className="col-lg-6 mb-10">
                ...
                <ALink className="btn btn-outline btn-block" href="#">
                  Full Width
                </ALink>
                <ALink
          ...
          <div className="container">
            <div className="btn-simple-wrapper mb-10 mt-4 pb-1">
              ...
              <div className="row align-items-center">
                <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                  <ALink href="#" className="btn btn-underline sm btn-link">
                    Underline 1
                  </ALink>
                </div>
                <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                ...
                <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                  <ALink href="#" className="btn btn-underline lg btn-link">
                    Underline 3
                  </ALink>
                </div>
                <div className="col-6 col-sm-4 col-md-3 col-lg-2">
            ...
            <div className="mb-10 pb-1">
              <div className="title-wrapper">
                ...
                <p className="text-center mb-2">
                  Size might vary from smaller screen to a larger screen.
                </p>
              </div>
              <div className="row">
                <div className="col-lg-6 btn-wrapper">
                  <ALink href="#" className="btn btn-outline btn-lg">
                    Large Size
                  </ALink>

                  <ALink href="#" className="btn btn-outline">
                    Normal Size
                  </ALink>

                  <ALink href="#" className="btn btn-outline btn-md">
                    Medium Size
                  </ALink>

                  <ALink href="#" className="btn btn-outline btn-sm">
                    Small Size
                  </ALink>
                </div>
                <div className="col-lg-6 btn-wrapper">
                  <ALink href="#" className="btn btn-block btn-outline">
                    Rectangle
                  </ALink>
        ...
        >
          <div className="container">
            <div className="title-wrapper title-white">
              ...
              <p className="text-center">
                These are the Button Style on dark Background.
              </p>
            </div>
            ...
            <div className="row">
              ...
              <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                <ALink href="#" className="btn btn-outline btn-block btn-bg">
                  Default
                </ALink>
              </div>
              <div className="col-6 col-sm-4 col-md-3 col-lg-2">
              ...
              <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                <ALink href="#" className="btn btn-outline btn-alert btn-block">
                  Alert Color
                </ALink>
              </div>
              <div className="col-6 col-sm-4 col-md-3 col-lg-2">
              ...
              <div className="col-6 col-sm-4 col-md-3 col-lg-2">
                <ALink href="#" className="btn btn-outline btn-block btn-white">
                  White Color
                </ALink>
              </div>
            </div>
