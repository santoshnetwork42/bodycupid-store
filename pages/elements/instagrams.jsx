          ...
          <OwlCarousel adClass="owl-theme gutter-no mb-4" options={mainSlider8}>
            <figure className="instagram instagram-info">
              ...
              <div className="instagram-content">
                <ALink href="#">
                  <i className="d-icon-heart"></i>136
                </ALink>
                <ALink href="#">
                  <i className="d-icon-comments"></i>136
                </ALink>
              </div>
            </figure>
            ...
            <figure className="instagram instagram-info">
              ...
              <div className="instagram-content">
                <ALink href="#">
                  <i className="d-icon-heart"></i>47
                </ALink>
                <ALink href="#">
                  <i className="d-icon-comments"></i>42
                </ALink>
              </div>
            </figure>
            ...
            <figure className="instagram instagram-info">
              ...
              <div className="instagram-content">
                <ALink href="#">
                  <i className="d-icon-heart"></i>6
                </ALink>
                <ALink href="#">
                  <i className="d-icon-comments"></i>11
                </ALink>
              </div>
            </figure>
            ...
            <figure className="instagram instagram-info">
              ...
              <div className="instagram-content">
                <ALink href="#">
                  <i className="d-icon-heart"></i>9
                </ALink>
                <ALink href="#">
                  <i className="d-icon-comments"></i>25
                </ALink>
              </div>
            </figure>
            ...
            <figure className="instagram instagram-info">
              ...
              <div className="instagram-content">
                <ALink href="#">
                  <i className="d-icon-heart"></i>8
                </ALink>
                <ALink href="#">
                  <i className="d-icon-comments"></i>17
                </ALink>
              </div>
            </figure>
          </OwlCarousel>
