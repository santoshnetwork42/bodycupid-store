          ...
          <section className="mt-10 pt-3">
            <div className="title-wrapper">
              ...
              <p className="text-body text-center mb-2">
                We provide some basic styling to header tags. For example,
                <br /> you can see 6 header tags' different sizes.
              </p>
            </div>
          ...
          <section className="mt-8">
            ...
            <div className="font-primary ">
              <p className="mb-3">
                ...
                himenaeos. Curabitur sodales ligula in libero. Vestibulum
                lacinia arcu eget nulla. Class aptent taciti sociosqu{" "}
              </p>
              <div className="row">
                <div className="col-md-6">
                  <ul className="list list-type-check mb-4">
                    ...
                    <li>
                      Tdio vulputate eleifend in in tortor. ellus
                      massa.Dristique sitiismonec.
                    </li>
                    <li>
                      Massa ristique sit amet condim vel, facilisis
                      quimequistiqutiqu amet condim.
                    </li>
                    <li>
