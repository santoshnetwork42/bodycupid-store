              ...
              <div className="banner-content bg-white d-lg-flex align-items-center">
                ...
                <div className="banner-text mb-lg-0 mb-4 mr-lg-4 pl-lg-6 pr-lg-0 pl-2 pr-2">
                  <h4 className="font-weight-normal ls-normal text-uppercase mb-0">
                    Get a Wow gift card+25% off
                  </h4>
                  <p className="ls-m mb-0">
              ...
              <div className="col-md-6 mb-4">
                <div className="banner banner-1 banner-fixed content-center content-middle">
                  ...
                  <div className="banner-content">
                    ...
                    <p className="ls-s text-light">
                      Get all the latest information on <br />
              ...
              <div className="col-md-6 mb-4">
                <div className="banner banner-2 banner-fixed content-center content-middle">
                  ...
                  <div className="banner-content">
                    ...
                    <p className="ls-normal text-white">
          ...
          >
            <div className="container">
              <div className="banner-content">
                ...
                <p className="text-white ls-s">
                  Free shipping on orders over $99
                </p>
                <ALink href="/shop" className="btn btn-primary btn-rounded">
                  Shop Now<i className="d-icon-arrow-right"></i>
                </ALink>
              </div>
            </div>
