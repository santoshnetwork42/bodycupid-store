...
function Alert(props) {
  return (
    <>
      ...
      <h1 className="d-none">
        Wow React eCommerce Template - Alert &amp; Notification
      </h1>
                  ...
                  {({ onToggle, setCollapsibleElement }) => (
                    ...
                    >
                      <div className="alert alert-primary alert-simple alert-inline">
                        <h4 className="alert-title">News : </h4> You have done 5
                        actions.
                        <button
                          type="button"
                  ...
                  {({ onToggle, setCollapsibleElement }) => (
                    ...
                    >
                      <div className="alert alert-success alert-simple alert-inline">
                        <h4 className="alert-title">Success : </h4> The page has
                        been added.
                        <button
                          type="button"
                          className="btn btn-link btn-close"
                  ...
                  {({ onToggle, setCollapsibleElement }) => (
                    ...
                    >
                      <div className="alert alert-warning alert-simple alert-inline">
                        <h4 className="alert-title">Warning : </h4> You have 190
                        messages.
                        <button
                          type="button"
                          className="btn btn-link btn-close"
                  ...
                  {({ onToggle, setCollapsibleElement }) => (
                    ...
                    >
                      <div className="alert alert-danger alert-simple alert-inline">
                        <h4 className="alert-title">Danger : </h4> The daily
                        report has failed.
                        <button
                          type="button"
                          className="btn btn-link btn-close"
                  ...
                  {({ onToggle, setCollapsibleElement }) => (
                    ...
                    >
                      <div className="alert alert-simple alert-primary alert-icon mb-4">
                        <i className="fas fa-check"></i> You have done 5
                        actions.
                        <button
                          type="button"
                          className="btn btn-link btn-close"
                  ...
                  {({ onToggle, setCollapsibleElement }) => (
                    ...
                    >
                      <div className="alert alert-light alert-primary alert-icon mb-4">
                        <i className="fas fa-exclamation-circle"></i> The page
                        has been added.
                        <button
                          type="button"
                          className="btn btn-link btn-close"
                  ...
                  {({ onToggle, setCollapsibleElement }) => (
                    ...
                    >
                      <div className="alert alert-light alert-danger alert-icon alert-inline mb-4">
                        ...
                        <h4 className="alert-title">Oh snap! </h4> Change a few
                  ...
                  {({ onToggle, setCollapsibleElement }) => (
                    ...
                    >
                      <div className="alert alert-message alert-light alert-primary alert-link mb-4">
                        ...
                        <p>
                          Lorem ipsum Minim ad pariatur eiusmod ea ut{" "}
                          <ALink href="#">nulla aliqua est quis</ALink> id
                          pariat minim vot nulla aliqualuptate.
                        </p>
                  ...
                  {({ onToggle, setCollapsibleElement }) => (
                    ...
                    >
                      <div className="alert alert-message alert-light alert-warning alert-inline mb-4">
                        ...
                        <p>
                          Lorem ipsum Minim ad pariatur eiusmod ea ut nulla quis
                          id dolore minim vot nulla aliqualuptate.
                        </p>
                        <button
                          type="button"
                          className="btn btn-link btn-close"
                  ...
                  {({ onToggle, setCollapsibleElement }) => (
                    ...
                    >
                      <div className="alert alert-primary alert-simple alert-btn">
                        <ALink href="#" className="btn btn-primary btn-md">
                          NEWS{" "}
                        </ALink>{" "}
                  ...
                  {({ onToggle, setCollapsibleElement }) => (
                    ...
                    >
                      <div className="alert alert-success alert-simple alert-btn">
                        <ALink href="#" className="btn btn-success btn-md">
                          SUCCESS{" "}
                        </ALink>{" "}
                      ...
                      <div className="alert alert-message alert-warning alert-dark alert-btn">
                        ...
                        <p>
                          ...
                          <ALink href="#" className="text-primary">
                            nulla aliqua est quis
                          </ALink>{" "}
                          id pariat minim vot nulla aliqualuptate.
                        </p>
                        ...
                        <ALink href="#" className="btn btn-secondary btn-md">
                          Or This
                        </ALink>
