            ...
            <div className="row">
                ...
                <div className="category category-default category-absolute overlay-zoom">
                  ...
                  <div className="category-content">
                    <h4 className="category-name">
                      <ALink href="shop.html">For Men's</ALink>
                    </h4>
              ...
              <div className="col-sm-6 col-lg-3 mb-4">
                <div className="category category-default category-absolute overlay-zoom">
                  ...
                  <div className="category-content">
                    <h4 className="category-name">
                      <ALink href="shop.html">Accessories</ALink>
                    </h4>
                    <ALink href="#" className="btn btn-primary">
                      Shop Now
                    </ALink>
              ...
              <div className="col-sm-6 col-lg-3 mb-4">
                <div className="category category-default category-absolute overlay-zoom">
                  ...
                  <div className="category-content">
                    <h4 className="category-name">
                      <ALink href="shop.html">Fashionable Women's</ALink>
                    </h4>
                    <ALink href="#" className="btn btn-primary">
                      Shop Now
                    </ALink>
              ...
              <div className="col-sm-6 col-lg-3 mb-4">
                <div className="category category-default category-absolute overlay-zoom">
                  ...
                  <div className="category-content">
                    <h4 className="category-name">
                      <ALink href="shop.html">Cosmetic</ALink>
                    </h4>
                    <ALink href="#" className="btn btn-primary">
                      Shop Now
                    </ALink>
          ...
          <section>
            ...
            >
              ...
              <div className="category category-light category-absolute overlay-zoom">
                ...
                <div className="category-content">
                  <h4 className="category-name">
                    <ALink href="#">Fashionable Women’s</ALink>
                  </h4>
                </div>
              </div>
          ...
          <section className="ellipse-section mt-10">
            ...
            <OwlCarousel adClass="owl-theme" options={mainSlider9}>
              <div className="category category-ellipse">
                ...
                <div className="category-content">
                  <h4 className="category-name">
                    <ALink href="#">Newborn Essentials</ALink>
                  </h4>
              ...
              <div className="category category-ellipse">
                ...
                <div className="category-content">
                  <h4 className="category-name">
                    <ALink href="#">Summer Sale is On</ALink>
                  </h4>
                  <span className="category-count">
                    <span>0</span> Products
                  </span>
              ...
              <div className="category category-ellipse">
                ...
                <div className="category-content">
                  <h4 className="category-name">
                    <ALink href="#">Footwear &amp; Accessories</ALink>
                  </h4>
                  <span className="category-count">
                    <span>0</span> Products
                  </span>
          ...
          <section className="mt-10 pt-4 border-container">
            ...
            <OwlCarousel adClass="owl-theme" options={mainSlider6}>
              <div className="category category-group-image">
                ...
                <div className="category-content">
                  <h4 className="category-name">
                    <ALink href="#">Electronics</ALink>
                  </h4>
                  <ul className="category-list">
                    <li>
                      <ALink href="#">Air conditioners</ALink>
                    </li>
                    <li>
                      <ALink href="#">Machines</ALink>
                    </li>
                    <li>
                      <ALink href="#">Musical instrument</ALink>
                    </li>
                    <li>
                      <ALink href="#">Office Electronics</ALink>
                    </li>
                    <li>
                      <ALink href="#">TV</ALink>
                    </li>
              ...
              <div className="category category-group-image">
                ...
                <div className="category-content">
                  <h4 className="category-name">
                    <ALink href="#">Fashion &amp; Clothings</ALink>
                  </h4>
                  <ul className="category-list">
                    <li>
                      <ALink href="#">Accessories</ALink>
                    ...
                    <li>
                      <ALink href="#">Bags &amp; Backpacks</ALink>
                    </li>
                    <li>
                      <ALink href="#">Men's</ALink>
                    </li>
                    <li>
                      <ALink href="#">Shoes &amp; Boots</ALink>
                    </li>
                    <li>
                      <ALink href="#">Women’s</ALink>
                    </li>
                  </ul>
                </div>
              </div>
              <div className="category category-group-image">
                ...
                <div className="category-content">
                  <h4 className="category-name">
                    <ALink href="#">Computers</ALink>
                  </h4>
                  <ul className="category-list">
                    <li>
                      <ALink href="#">Desktop PC</ALink>
                    </li>
                    <li>
                      <ALink href="#">Laptop</ALink>
                    </li>
                    <li>
                      <ALink href="#">PC Components</ALink>
                    </li>
                    <li>
                      <ALink href="#">PC Gaming</ALink>
                    </li>
                    <li>
                      <ALink href="#">Storage &amp; Memory</ALink>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <OwlCarousel adClass="owl-theme" options={mainSlider6}>
              ...
              >
                ...
                <div className="category-content">
                  <ul className="category-list">
                    ...
                    <li>
                      <ALink href="#">Bracelets</ALink>
                    </li>
                    <li>
                      <ALink href="#">Men's Necklace</ALink>
                    </li>
                    <li>
              ...
              >
                ...
                <div className="category-content">
                  <ul className="category-list">
                    ...
                    <li>
                      <ALink href="#">Training Shirt</ALink>
                    </li>
                    <li>
                      <ALink href="#">Women's</ALink>
                    </li>
              ...
              >
                ...
                <div className="category-content">
                  <ul className="category-list">
                    <li>
                      <ALink href="#">Fashion Bags</ALink>
                    </li>
                    <li>
                      <ALink href="#">Hand Bags</ALink>
                    </li>
                    <li>
                      <ALink href="#">Kid's Bags</ALink>
                    </li>
                    <li>
                      <ALink href="#">Men's Bags</ALink>
                    </li>
                    <li>
                      <ALink href="#">Trip Bags</ALink>
                    </li>
                    <li>
                      <ALink href="#">Women's</ALink>
                    </li>
              ...
              <div className="grid-item height-x2">
                <div className="category category-banner category-absolute overlay-light">
                  ...
                  <div className="category-content">
                    ...
                    <ALink href="#" className="btn btn-underline btn-link">
                      Shop Now
                    </ALink>
                  </div>
                </div>
              ...
              <div className="grid-item height-x2">
                <div className="category category-badge category-absolute overlay-dark">
                  ...
                  <div className="category-content">
                    ...
                    <ALink className="btn btn-primary btn-block" href="#">
                      Shop Now
                    </ALink>
                  </div>
                </div>
