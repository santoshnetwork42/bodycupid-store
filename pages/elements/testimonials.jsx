      ...
      <div className="page-content">
            ...
            <OwlCarousel adClass="owl-theme" options={mainSlider6}>
              <div className="testimonial">
                <blockquote>
                  ...
                  eu ante eget nisl convallis tempus Phsellus anctus, tincidunt
                  tincidunt dui.
                </blockquote>
                ...
                <OwlCarousel adClass="owl-nav-bottom" options={mainSlider7}>
                  <div className="testimonial">
                    <blockquote>
                      ...
                      Sed eu ante eget nisl convallis tempus Phsellus anctus,
                      tincidunt tincidunt dui.met, consectetur adipiscing elit.
                      Sed eu ante eget nisldolor sit amet.
                    </blockquote>
                    <div className="testimonial-info">
                      <figure className="testimonial-author-thumbnail">
                        <img
        ...
        >
          <div className="container mt-4 mb-4">
            <h2 className="title title-center title-white mb-0">
