      ...
      <div className="page-content">
        ...
        <section className="mt-10 pt-4 mb-10 pb-4">
          <div className="container">
              ...
              <div className="icon-box icon-solid text-center">
                <span className="icon-box-icon">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M34.833,55.938c-0.813,0-1.6-0.162-2.344-0.48l-21.675-9.285l-9.761,4.553c-0.651,0.303-1.063,0.961-1.051,1.679
                    ...
                    />
                    <path
                      d="M34.832,35.331C34.833,35.331,34.833,35.331,34.832,35.331c0.243,0,0.486-0.048,0.714-0.146l27.801-11.814l5.546-2.357
              ...
              <div className="icon-box icon-solid text-center">
                <span className="icon-box-icon">
                  ...
                  >
                    <g opacity="0.5">
                      <path
                        d="M64.03,67.5H5.968c-2.125,0-4.107-1.979-5.171-3.821c-1.063-1.843-1.063-4.546,0-6.39L29.828,6.798
            ...
            <h2 className="title title-center mb-5">
              Solid icon &amp; Left align
            </h2>
