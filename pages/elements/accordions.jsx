      ...
      <div className="page-content">
        ...
        <section className="pt-10 pb-8 grey-section">
          <div className="container mt-4">
            <div className="row">
              <div className="col-md-6 mb-6">
                <h2 className="title title-sm title-center mb-5">
                  On Background
                </h2>
                <Accordion adClass="accordion-boxed accordion-plus accordion-gutter-md">
                  <Card title="First Header" expanded={true}>
                    <p className="mb-0">
                      ...
                      partes, eripuit praesenti congressus ostendit alienae,
                      voluptati ornateque accusamus clamat reperietur convicia
                      albucius, veniat quocirca vivendi aristotele errorem
                      epicurus. Suppetet. Aeternum animadversionis.
                    </p>
                  </Card>
