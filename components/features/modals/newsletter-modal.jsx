        ...
        >
            <div className="newsletter-popup" id="newsletter-popup" style={{ backgroundImage: "url(images/newsletter-popup.jpg)" }}>
                <div className="newsletter-content">
                    ...
                    <h2 className="font-weight-semi-bold">Sign up to <span>Wow</span></h2>
                    <p className="text-grey">Subscribe to the Wow eCommerce newsletter to receive timely updates from your favorite products.</p>
