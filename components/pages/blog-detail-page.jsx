      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/blog" legacyBehavior>
            <a className="text-blue-500 hover:underline">Return to blog listing</a>
          </Link>
        </div>
      </div>
    );
      ...
      <div className="seo-blog-post max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <article className="article">
          ...
          <header className="mb-8 header">
            ...
            <div className="blogTitle">{blog.metaDescription || "No title"}</div>
            <div className="category">{blog.category.title || "No category"}</div>
          ...
          {blog.html ? (
            <div className="prose prose-lg max-w-full" dangerouslySetInnerHTML={{ __html: blog.html }} />
          ) : (
