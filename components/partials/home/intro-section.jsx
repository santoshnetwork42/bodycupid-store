                    ...
                    <div className="banner-content y-50 ml-auto text-right">
                        <Reveal keyframes={fadeInUpShorter} delay={1000} duration={1200}>
                            <p className="font-primary ls-s text-dark mb-4">
                                Stir in the power of <br />vitamin B7 for healthier<br />skin and stronger hair.
                            </p>
                        </Reveal>
                ...
                <div className="container">
                    <div className="banner-content y-50 ml-auto">
                        <Reveal keyframes={fadeInUpShorter} delay={1000} duration={1200}>
                            ...
                            <h3 className="font-weight-normal">Manage weight with the goodness of 100% organic Himalayan apples.</h3>
                        </Reveal>

                        <Reveal keyframes={fadeInUpShorter} delay={1800} duration={1000} className="text-right">
                            <ALink href="/shop" className="btn btn-dark btn-rounded">Shop Now<i className="d-icon-arrow-right"></i></ALink>
                        </Reveal>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="banner-content x-50 y-50 text-center">
                        <Reveal keyframes={fadeInUp} delay={800} duration={1000}>
                            <p className="mb-7 ls-s font-primary">Your mega source of good fats.<br />For a healthy heart.</p>
                        </Reveal>
