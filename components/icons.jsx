...
export const Bag = ({ size = defaultIconSize, color = defaultIconColor }) => {
  return (
    ...
    >
      <path
        fill={color}
        d="M400 160h-80V96c0-52.94-43.06-96-95.1-96S128 43.06 128 96v64H48c-17.67 0-32 14.33-32 32v240c0 44.2 35.82 80 80 80h256c44.18 0 80-35.82 80-80V192c0-17.7-14.3-32-32-32zM144 96c0-44.11 35.88-80 80-80s80 35.89 80 80v64H144V96zm272 336c0 35.29-28.71 64-64 64H96c-35.29 0-64-28.71-64-64V192c0-8.822 7.176-16 16-16h80v72c0 4.4 3.6 8 8 8s8-3.6 8-8v-72h160v72c0 4.4 3.6 8 8 8s8-3.6 8-8v-72h80c8.8 0 16 7.2 16 16v240z"
      ></path>
    </svg>
  );
};
...
export const Star = ({ size = defaultIconSize, color = defaultIconColor }) => {
  return (
    ...
    >
      <path
        fill={color}
        d="M139.9 512c-7.062 0-14.09-3.344-18.78-8.969-4.593-5.5-6.437-12.5-5.187-19.75l26.19-154.8L31.33 218.9c-6.718-6.625-8.999-16-6.093-25.03C28.11 184.8 35.46 178.5 44.83 177.1l152.97-22.6 68.4-140.8C270.3 5.125 278.5 0 287.1 0c9.374 0 17.73 5.25 21.86 13.69L378.2 154.5l152.1 22.62c9.218 1.375 16.72 7.812 19.56 16.78 2.906 9 .625 18.38-6.093 25l-110.8 109.6 26.19 154.8c1.219 7.312-.625 14.28-5.187 19.72-7.093 8.625-19.1 11.5-30.09 6.094L288 436.1l-136.8 73.03c-3.5 1.87-7.3 2.87-11.3 2.87zM280.6 20.69L208.5 169.1 47.17 192.9c-7.67 1.2-8.94 10.3-4.59 14.6l116.7 115.4-27.62 163c-1.36 8.2 7.04 11.8 11.94 9.1L288 417.9l144.3 77.03c5.074 2.8 13.28-1.063 11.97-9.031l-27.59-162.1 116.7-115.4c4.376-4.319 2.926-13.44-4.593-14.59l-161.3-23.88-72.09-148.4C292.5 14.75 283.8 14.07 280.6 20.69z"
      ></path>
    </svg>
  );
};
...
export const MagnifyingGlass = ({
  ...
  return (
    ...
    >
      <path
        fill={color}
        d="M504.1 471l-134-134c29-35.5 45-80.2 45-129 0-114.9-93.13-208-208-208S0 93.13 0 208s93.12 208 207.1 208c48.79 0 93.55-16.91 129-45.04l134 134c5.6 4.74 11.8 7.04 17.9 7.04s12.28-2.344 16.97-7.031c9.33-9.369 9.33-24.569-.87-33.969zM48 208c0-88.22 71.78-160 160-160s160 71.78 160 160-71.78 160-160 160S48 296.2 48 208z"
      ></path>
    </svg>
  );
};
