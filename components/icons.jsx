...
export const HeartThin = ({ size = defaultIconSize, color = defaultIconColor }) => {
  return (

    <svg width={size}
    height={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    <path fill={color}d="M462.1 62.86C438.8 41.92 408.9 32 378.7 32c-37.49 0-75.33 15.4-103 43.98L256 96.25l-19.7-20.27C208.6 47.4 170.8 32 133.3 32c-30.2 0-60.07 9.92-84.26 30.86C-13.1 116.7-16.21 212.5 39.81 270.5l193.2 199.7c6.39 6.5 14.59 9.8 22.89 9.8 8.336 0 16.69-3.269 23.01-9.804l193.1-199.7C528.2 212.5 525.1 116.6 462.1 62.86zm-1.5 196.54L267.5 459.1c-3.1 3.2-7.2 4.9-12.4 4.9-4.336 0-8.414-1.75-11.49-4.93l-193.1-199.7c-23.93-24.77-36.76-59.07-35.2-94.13 1.578-35.36 16.98-67.43 43.39-90.28C79.89 57.32 105.4 48 133.3 48c34.13 0 67.49 14.23 91.54 39.05l31.18 32.19 31.18-32.19C311.2 62.23 344.6 48 378.7 48c27.89 0 53.4 9.32 73.77 26.96 26.41 22.86 41.82 54.93 43.37 90.29 1.56 35.05-11.24 69.35-35.24 94.15z"></path>
  </svg>
  );
};
...
export const Bag = ({ size = defaultIconSize, color = defaultIconColor }) => {
  return (
    ...
    >
      <path
        fill={color}
        d="M416 160h-72v-40C344 53.83 290.2 0 224 0S104 53.83 104 120v40H32c-17.67 0-32 14.3-32 32v240c0 44.2 35.82 80 80 80h288c44.18 0 80-35.82 80-80V192c0-17.7-14.3-32-32-32zm-264-40c0-39.7 32.3-72 72-72s72 32.3 72 72v40H152v-40zm248 312c0 17.64-14.36 32-32 32H80c-17.64 0-32-14.36-32-32V208h56v56c0 13.3 10.8 24 24 24s24-10.75 24-24v-56h144v56c0 13.3 10.8 24 24 24s24-10.75 24-24v-56h56v224z"
      ></path>
    </svg>
  );
};
...
export const Star = ({ size = defaultIconSize, color = defaultIconColor }) => {
  return (
    <svg
      ...
      viewBox="0 0 576 512"
    >
      <path fill={color} d="M316.7 17.8l65.43 132.4 146.4 21.29c26.27 3.796 36.79 36.09 17.75 54.59l-105.9 102.1 25.05 145.5c4.508 26.31-23.23 45.9-46.49 33.7L288 439.6l-130.9 68.7c-23.3 12.2-51-7.4-46.5-33.7l25.05-145.5-105.93-103c-19.03-18.5-8.516-50.79 17.75-54.59l146.4-21.29 65.43-132.4c11.8-23.903 45.7-23.606 57.4-.02z"></path>
    </svg>
  );
};
...
export const MagnifyingGlass = ({
  ...
  return (
    <svg
      ...
      height={size}
    >
      <path fill={color} d="M504.1 471l-134-134c29-35.5 45-80.2 45-129 0-114.9-93.13-208-208-208S0 93.13 0 208s93.12 208 207.1 208c48.79 0 93.55-16.91 129-45.04l134 134c5.6 4.74 11.8 7.04 17.9 7.04s12.28-2.344 16.97-7.031c9.33-9.369 9.33-24.569-.87-33.969zM48 208c0-88.22 71.78-160 160-160s160 71.78 160 160-71.78 160-160 160S48 296.2 48 208z"></path>
    </svg>
  );
};
...
export const MagnifyingGlassThin = ({
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
    >
      <path fill={color} d="M509.7 498.3L360.5 349.1c34.3-37 54.6-86.5 54.6-141.1 0-114.9-93.13-208-208-208S0 93.13 0 208s93.12 208 207.1 208c54.55 0 104.1-21.17 141.2-55.54l149.2 149.2c2.4 1.54 4.4 2.34 5.6 2.34s4.094-.781 5.656-2.344c4.044-3.156 4.044-8.156.944-11.356zM207.1 400c-105.9 0-192-86.13-192-192s86.13-192 192-192 192 86.13 192 192-85.2 192-192 192z"></path>
    </svg>
  );
};
