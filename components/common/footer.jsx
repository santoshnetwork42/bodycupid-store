            ...
            <div className="container">
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-3">
                            <ALink href="/" className="logo-footer">
                                <img src="/images/logo.png" alt="logo-footer" width="154" height="43" />
                            </ALink>
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6">
                            <div className="widget widget-info">
                                ...
                                <ul className="widget-body">
                                    ...
                                    <li>
                                        <label>Address: </label>
                                        <ALink href="#">Body Cupid Pvt Ltd. #51, IndiQube Penta, 5th Floor, Richmond Road, Bengaluru 560025, Karnataka, India.</ALink>
                                    </li>
                                    <li>
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="widget ml-lg-4">
                                ...
                                <ul className="widget-body">
                                    <li>
                                        <ALink href="/pages/about-us">Omega Fatty Acids</ALink>
                                    </li>
                                    <li>
                                        <ALink href="#">Weight Management</ALink>
                                    </li>
                                    <li>
                                        <ALink href="#">Immunity Care</ALink>
                                    </li>
                                    <li>
                                        <ALink href="#">Men's Health</ALink>
                                    </li>
                                    <li>
                                        <ALink href="#">Gut Health</ALink>
                                    </li>
                                    <li>
                                        <ALink href="#">Detox</ALink>
                                    </li>
                                    <li>
                                        <ALink href="#">Skin & Hair Nutrition</ALink>
                                    </li>
                                    <li>
                                        <ALink href="#">Specialty Supplements</ALink>
                                    </li>
                                    <li>
                                        <ALink href="#">Proteins</ALink>
                                    </li>
                                    <li>
                                        <ALink href="#">Proteins</ALink>
                                    </li>
                ...
                <div className="footer-bottom">
                    ...
                    <div className="footer-center">
                        <p className="copyright ls-normal">Wow eCommerce &copy; 2021. All Rights Reserved</p>
                    </div>
