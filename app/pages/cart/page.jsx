          ...
          <div className="row">
            {lineItems.length > 0 ? (
              ...
              <div className="empty-cart text-center">
                <p className="mt-2 text-black font-weight-bold">Your cart is currently empty.</p>
                <i className="cart-empty d-icon-bag"></i>
                <p className="return-to-shop mb-0">
                  <ALink className="button wc-backward btn btn-dark btn-md" href="/collections/all">
                    Return to shop
                  </ALink>
                </p>
              </div>
...
export default connect(
  (state) => ({ store: state.system.store, appliedCoupon: state.cart.coupon }),
  { viewCart: eventActions.viewCart, validateCart: cartActions.validateCart }
)(Cart);
